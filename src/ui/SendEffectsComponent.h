...
private:
    ...
    // Column counts
    static constexpr int kDelayColumns = 8;  // Time, Sync Div, BPM Sync, Dotted, Feedback, Filter, Cutoff, Ping Pong
    static constexpr int kReverbColumns = 4; // Room Size, Decay, Damping, Pre-Delay
