...
private:
    ...
    void setCurrentPatternLength (int newLength);
    void setRowsPerBeatFromToolbar (int rowsPerBeat);
    void setEditStepFromToolbar (int step);
    void setOctaveFromToolbar (int octave);
    void setCurrentInstrumentFromToolbar (int instrument);
    void switchToPattern (int index);
    void showPatternSelectorEditor();
    void showPatternLengthEditor();
    void showPatternNameEditor();
    void showInstrumentEditor();
    void showOctaveEditor();
    void showEditStepEditor();
    void showBpmEditor();
    void showRowsPerBeatEditor();
    ...
    bool trackHasProjectData (int track) const;
    bool noteLaneHasProjectData (int track, int noteLane) const;
    void removeTrackLaneFromHeader (int track);
    void removeNoteLaneFromHeader (int track, int noteLane);
